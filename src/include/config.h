...
///// Package Information /////////////////////////////////////////////////////
#ifdef XHYPER255A
#define PACKAGE				"MT608-XHYPER255A"	// Name of package.
#define VERSION				"R2"		// Version number of package.
#else
#define PACKAGE				"MT608-FLASH 16MB"	// Name of package.
#define VERSION				"R2"		// Version number of package.
#endif

// Position of BOOT LOADER.
// Bootloader: A3FC0000 (0xA4000000 - 0x40000)
